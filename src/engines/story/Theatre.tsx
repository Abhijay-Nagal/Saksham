...
export function Theatre({ scene, cast, speaker, talking, open }: TheatreProps) {
  ...
  return (
    <div className="overflow-hidden rounded-panel sticker" style={{ background: '#A8274F' }}>
      {/* Valance: rani band, marigold trim, scalloped edge */}
      <div className="relative h-9 border-b-[3px] border-marigold bg-rani md:h-11">
        <div
          aria-hidden
      ...
      <div
        className="relative mx-4 aspect-4/5 overflow-hidden md:mx-9 md:aspect-video"
